...
export function Footer() {
  return (
    <footer id="docs" className="bg-card border-t border-border py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Python-first smart contract toolkit for Arbitrum. Write, compile, and deploy with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="https://docs.arbitrum.io" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">Arbitrum Docs</a></li>
              <li><a href="https://docs.arbitrum.io/stylus" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">Stylus Docs</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © 2024 ArbitPy. All rights reserved.
          </p>
